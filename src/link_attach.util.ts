  ...
  versionName: string
    ...
    try {
        ...
        if (error instanceof Error) {
            console.error(`An error occurred while creating attachment for issue:`, error.message);
        } else {
            console.error(`An error occurred while creating attachment for issue:`, error);
        }
        if (
            typeof error === 'object' &&
            error !== null &&
